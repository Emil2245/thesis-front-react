...
export function GridSeccion({
  ...
  return (
    ...
    >
      {vacia ? (
        // La sección vacía sigue siendo visible: el plan 074 recupera el
        // "armado posterior" desde EditorApuPage. Un texto discreto basta para
        // que la tarjeta no parezca rota; el botón de la cabecera hace el trabajo.
