...
## 06. Alcance incluido
Inspeccionar credenciales únicamente en `../thesis-back-quarkus/api/bruno/environments/dev.bru`, sin copiar secretos. Ejecutar real-backend journeys de auth, workspace, APU/ET, Resumen, Cronograma y admin; validar en Cronograma los tabs, segmentos no consecutivos, PATCH semánticos, matriz y Curva S; endurecer MSW/Playwright; a11y, screenshots, manual, baseline, índice/bitácora y los 13 comentarios administrativos obsoletos ya inventariados.
...
## 10. TDD/regresión
**RED:** añadir/ajustar aserciones de journey que fallen por contrato real, handlers que rechacen bodies extra y pruebas a11y/visual con expectativa concreta. Resumen y Cronograma se navegan como rutas independientes; no se busca una pestaña de cronograma en `WorkspacePage`. **GREEN:** corregir solo integración/fixtures. **TRIANGULATE:** 401/403/404, stale/error, no selección, cuerpos inválidos, `?v` + `?vista`, teclado y navegador limpio. **REFACTOR:** limpiar comentarios stale sin cambiar alcance.
...
Journeys auth/workspace/APU/ET/Resumen/Cronograma/admin pasan real y mock; Resumen y Cronograma conservan rutas separadas; requests/body/status están afirmados; los tres tabs del cronograma, Gantt interactivo, matriz y gráfica tienen evidencia; a11y/screenshot/manual pasan; baseline reporta conteo medido; índice DAG y bitácora enlazan evidencia; no hay secreto ni scope creep.
