...
Baseline actual: **609 tests unitarios en 88 archivos, todos en verde**, y `pnpm run verify` pasa
entero —typecheck, lint, guard:adr9, format:check, test y build—. Medido el 2026-09-10 después de
corregir la respuesta nullable de proyectos e integrar los Planes 090 y 092 sobre los Planes 077–087. Antes de esa rama eran 459 ✅ / **20 ❌** en 75 archivos, con `typecheck` y
